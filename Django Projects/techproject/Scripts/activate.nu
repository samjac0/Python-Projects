...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\jacob\Desktop\Development\Projects\Python Projects\Django\test1'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\jacob\Desktop\Development\Projects\Python Projects\Django\test1\Scripts\deactivate.nu'

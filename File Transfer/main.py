...
class window(Frame):
    ...
    # "Set User" button
        ...
        self.button.grid( row = 4, column = 0, columnspan = 1, pady=(0,30), padx = (30,40), sticky = W+E+N+S)


    
    # Server Textbox description 
        self.lblTitle1 = tk.Label(self.master,text='Server Directory:')
        self.lblTitle1.grid(row=5,column=0,columnspan=2,padx=(27,0),pady=(10,0),sticky=N+W)

    # Server Textbox 
        self.labelTxt1 = tk.Entry(self.master,width=60, text='')
        self.labelTxt1.grid(row = 6,column = 0,rowspan = 1,columnspan = 2,padx = (30,40),pady = (0,10),sticky = N+E+W)

    # "Set Server" button
        self.button1 = Button(self.master, text = "Set Server Directory", width = 5,
                               command=lambda: functions1.file_pathB(self))
        self.button1.grid( row = 7, column = 0, columnspan = 1, pady=(0,30), padx = (30,40), sticky = W+E+N+S)
        ...
        self.btn_update.grid(row=8,column=0,padx=(30,0),pady=(30,10),sticky=W)
